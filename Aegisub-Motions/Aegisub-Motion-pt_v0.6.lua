...
script_description = "Um conjunto de ferramentas para simplificar o processo de criar e aplicar dados de 'motion-track' no Aegisub."
	...
	gui = {
		main = {
			linespath = {
				...
				4,
				name = "linespath",
				hint = "Colar dados ou o caminho para o ficheiro que os contenham. Sem aspas ou \."
			},
			pref = {
				"textbox",
				0,
				...
				name = "pref",
				hint = "O prefixo",
				hint = "O directório onde todos os ficheiros gerados são guardados."
			},
			preflabel = {
				"label",
				0,
				...
				10,
				1,
				label = "									Os ficheiros irão ser guardados neste directório."
			},
			datalabel = {
				"label",
				0,
				...
				10,
				1,
				label = "											 Colar dados ou introduzir um caminho de ficheiros."
			},
			optlabel = {
				"label",
				0,
